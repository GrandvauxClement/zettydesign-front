const ServiceAccueilData = [
    ...
    },
    {
        ...
        description: 'Développons votre E réputation, pour accroître votre visibilité sur les réseaux sociaux. ' +
            'Je propose à mes clients un accompagnement stratégique & opérationnel sur les différents médias numériques.' +
    ...
    },/*
    {
        ...
        description: 'Après une étude de marché détaillée, élaborons ensemble votre plan de communication sur mesure.' +
            ' Adaptée à vos moyens humains et financiers, développons votre communication pour saisir les opportunités' +
            ' de votre marché. J’offre à mes clients un accompagnement personnalisé pour les conseiller au mieux dans' +
...
export default ServiceAccueilData;